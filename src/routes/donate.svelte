      ...
      <div class="pt-6 mb-6 lg:text-justify px-6">
        <div class="flex flex-wrap justify-between">
          ...
          <div class="w-full lg:w-1/2 justify-center text-center m-auto">
            ...
            <a href="https://www.helloasso.com/associations/sheaft/adhesions/adhesion-sheaft-2021/" target="_blank" class="ml-1 block md:inline mx-auto hover:underline bg-accent font-bold rounded-full my-6 py-4 px-8 shadow-lg text-white cusor-pointer">
              Adhérer
            </a>
          </div>
        </div>
